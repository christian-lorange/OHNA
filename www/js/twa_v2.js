...
function ShowActions(flTWA)
{
	if(flTWA > 0) {
		if(flTWA < nexp.action) {
			...
			// document.getElementById("divActionAction").innerHTML = "The worker's time weighted average is less than the action level so <strong>no further action is required</strong> other than regular noise measurement, especially when there are any changes to the environment or machinery.";
			//document.getElementById("fldAction").value = "The worker's time weighted average is less than the action level so <strong>no further action is required</strong> other than regular noise measurement, especially when there are any changes to the environment or machinery.";
		}
		...
		if((flTWA >= nexp.action) && (flTWA < nexp.crit)) {
			...
			//document.getElementById("divActionAction").innerHTML = "<p>The worker's time weighted average is above the action level of " + nexp.action.toFixed(0) + " dB.</p><ul><li>Reduce the noise at source wherever possible.</li><li>Provide the worker with training about hearing damage and protection.</li><li>Provide suitable hearing protection to be worn if the worker chooses to.</li><li>Carry out regular monitoring of the noise levels to ensure they have not increased.  </li></ul>";
			//document.getElementById("fldAction").value = "<p>The worker's time weighted average is above the action level of " + nexp.action.toFixed(0) + " dB.</p><ul><li>Reduce the noise at source wherever possible.</li><li>Provide the worker with training about hearing damage and protection.</li><li>Provide suitable hearing protection to be worn if the worker chooses to.</li><li>Carry out regular monitoring of the noise levels to ensure they have not increased.  </li></ul>";
		}
		if((flTWA >= nexp.crit) && (flTWA < nexp.crit+10)) {
			...
			//document.getElementById("divActionAction").innerHTML = "<p>The worker's time weighted average is above the criterion level of " + nexp.crit.toFixed(0) + " dB.</p><ul><li>Reduce the noise at source wherever possible</li><li>Provide the worker with training about hearing damage and protection.</li><li><strong>Provide suitable hearing protection, which must be worn</strong></li><li>Carry out regular monitoring of the noise levels to ensure they have not increased.</li></ul>";
			//document.getElementById("fldAction").value = "<p>The worker's time weighted average is above the criterion level of " + nexp.crit.toFixed(0) + " dB.</p><ul><li>Reduce the noise at source wherever possible</li><li>Provide the worker with training about hearing damage and protection.</li><li><strong>Provide suitable hearing protection, which must be worn</strong></li><li>Carry out regular monitoring of the noise levels to ensure they have not increased.</li></ul>";
		}
		if(flTWA >= nexp.crit+10) {
			document.getElementById("divActionLevels").innerHTML = "Exposure is<br>very high";
			//document.getElementById("divActionAction").innerHTML = "<p>The worker's time weighted average is well above the criterion level. This noise level is so high that a more detailed analysis will be required to ensure that the hearing protection provided is adequate.</p><ul><li>Reduce the noise at source wherever possible</li><li>Provide the worker with training about hearing damage and protection.</li><li><strong>Provide suitable hearing protection, which must be worn</strong></li><li><strong>Carry out further analysis to ensure that the protection provided is adequate for the job</strong>. </li></ul>";
			//document.getElementById("fldAction").value = "<p>The worker's time weighted average is well above the criterion level. This noise level is so high that a more detailed analysis will be required to ensure that the hearing protection provided is adequate.</p><ul><li>Reduce the noise at source wherever possible</li><li>Provide the worker with training about hearing damage and protection.</li><li><strong>Provide suitable hearing protection, which must be worn</strong></li><li><strong>Carry out further analysis to ensure that the protection provided is adequate for the job</strong>. </li></ul>";
		}
